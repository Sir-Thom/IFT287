...
public class Connexion implements IConnexion
{
    ...
    public Connexion(String serveur, String bd, String user, String pass)
            throws SeauSException, SQLException
    {
        Driver d;
        try
        {
            ...
            {
                conn = DriverManager.getConnection("jdbc:postgresql://bd-info2.dinf.usherbrooke.ca:5432/" + bd, user, pass);
            }
            else
            {
        ...
        catch (Exception e)
        {
            ...
            throw new SeauSException("JDBC Driver non instancié");
        }
    }
